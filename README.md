...
**_EPlus-LLM [v1](https://huggingface.co/EPlus-LLM/EPlus-LLMv1)/[v2](https://huggingface.co/EPlus-LLM/EPlus-LLMv2) models along with [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Gangjiang1/EPlus-LLM/blob/main/v2/EPlus-LLMv2_inference.ipynb) quick-start code are open-sourced on [Huggingface](https://huggingface.co/EPlus-LLM)_**
